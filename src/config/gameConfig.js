...
export const CARDS_DB = {
    ...
    [CARD_TYPES.DODGE]: { id: CARD_TYPES.DODGE, name: '【腾云】', desc: '被动防御：抵消一张【降妖】或【漫天花雨】。', icon: Shield, color: 'text-green-600', bg: 'bg-green-50', border: 'border-green-200' },
    [CARD_TYPES.HEAL]: { id: CARD_TYPES.HEAL, name: '【蟠桃】', desc: '自己恢复1点体力。', icon: Heart, color: 'text-pink-600', bg: 'bg-pink-50', border: 'border-pink-200' },
    [CARD_TYPES.STUN]: { id: CARD_TYPES.STUN, name: '【定身咒】', desc: '使单体目标跳过下个出牌阶段。', icon: Zap, color: 'text-yellow-600', bg: 'bg-yellow-50', border: 'border-yellow-200' },
    ...
    [CARD_TYPES.STEAL]: { id: CARD_TYPES.STEAL, name: '【探囊取物】', desc: '随机获得单体敌人1张手牌。', icon: Magnet, color: 'text-purple-600', bg: 'bg-purple-50', border: 'border-purple-200' },
...
export const PLAYER_CHARACTERS = [
    {
        ...
        activeName: '【火眼金睛】', activeDesc: '主动：每回合限1次。洞察破绽，随机弃置1名存活妖王的1张手牌。'
    },
    {
    ...
    },
    {
        ...
        activeName: '【紧箍咒语】', activeDesc: '主动：每回合限1次。弃置 1 张手牌，对指定妖王造成 1 点流失伤害。'
    },
    {
